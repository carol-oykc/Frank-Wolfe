                ...
                for Xn0_1 = [0,6]
                   for X0_location = X0s
                      ...
                      for e = 10.^E
                          i = i+1;
                          j = j+1;
                          plot_table = statarray(table2array(statarray(:,'Dn0'))==Dn0 & table2array(statarray(:,'constraint'))==constraint & table2array(statarray(:,'X0_location'))==X0_location & table2array(statarray(:,'variant'))==variant & table2array(statarray(:,'Xn0_1'))==Xn0_1 & table2array(statarray(:,'accuracy'))==e , :);
                          x_axis = table2array(plot_table(:,'step_rule'));
                          ...
                          %title(['Dn0=',num2str(Dn0),' constraint=',num2str(constraint),' Xn0=',num2str(Xn0),' Xn1=',num2str(Xn1),' variant=',num2str(variant),' accuracy=',num2str(e),' stepsize rule=',num2str(step_rule)])
                          %saveas(h1,['C:\Users\s1964667\OneDrive - University of Edinburgh\summer project\final_result\cons0_', num2str(j) ,'_1.png'])
                          %delete(h1)
                          ...
                          xlabel("Step size rule")
                          %ylabel("Running time")
                          title(['accuracy: ',num2str(e)])
                      ...
                      saveas(gcf,['C:\Users\s1964667\OneDrive - University of Edinburgh\summer project\final_result\cons0_', num2str(j) ,'.png'])
